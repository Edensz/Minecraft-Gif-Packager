package me.eden.extractor.listeners;

import me.eden.Main;
import me.eden.extractor.manager.GifFrameExtractor;
...
public class ExtractFramesJButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        File selectedFolder = (File) Main.folderLabel.getClientProperty("selectedFolder");
